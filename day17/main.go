...
func main() {
	...
	for y := range cityMap[0] {
		for x := range cityMap {
			...
			shortestPaths[x][y][north] = []int{MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT}
			shortestPaths[x][y][east] = []int{MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT}
			shortestPaths[x][y][south] = []int{MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT}
			shortestPaths[x][y][west] = []int{MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT}
		}
	}
...
func calculateShortestPath() {
	...
	pq = append(pq, &Item{
		x: 0, y: 0, shortestPathLength: 0, direction: south, count: -1,
	})
	heap.Init(&pq)
...
func createItem(origItem *Item, direction int) *Item {
	...
	if origItem.count < 3 && origItem.direction != direction {
		return nil
	}
